...
const RiskRuleUpdateAfterCreate = () => {
  ...
  const handleNext = () =>{
    ...
    if (masterRule.ruleMethod == "C") {
        if(state.check == "NotCreated"){
          navigate.push("/riskrulecreatecountpage", {
            state: {
              MasterRuleId: state.id,
              DocumentType: masterRule.documentTypeId,
              DocumentName: masterRule.documentType,
              ThreatGroup: masterRule.threatGroupId,
              ThreatGroupName : masterRule.threatGroup,
              RuleType: masterRule.ruleTypeRefId,
              RuleTypeName : masterRule.ruleName,
              CaseType: masterRule.caseTypeRefId,
              CaseTypeName : masterRule.caseTypeRef,
              RuleMethod: masterRule.ruleMethod == "C" ? "Count" : "Decision",
              DocSeq : masterRule.docSeq,
              statusCode : masterRule.statusCode,
              check :state.check
            },
          });
        }
        else if(state.check == "Created"){
...
export default RiskRuleUpdateAfterCreate;
